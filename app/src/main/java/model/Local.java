...
public class Local {
    ...
    public Local(String idLocal, String nombre, String numero, String area, String codigoCategoria, String codigoSubcategoria, String codigoBien, String centroComercial, String gestionado) {
        ...
        if(categoria.equalsIgnoreCase("Moda, Muebles y Enseres")) {
            ...
            if (subcategoria.equalsIgnoreCase("Moda")) {
                ...
                if (descripcionBien.equalsIgnoreCase("Ropa para damas")) {
                    codigoBien = 1 + "";
                } else if (descripcionBien.equalsIgnoreCase("Ropa para hombres")) {
                    codigoBien = 2 + "";
            ...
            if (subcategoria.equalsIgnoreCase("Entretenimiento")){
                ...
                if(descripcionBien.equalsIgnoreCase("Cine")){
                    ...
                    codigoBien = 3 + "";
                }else if(descripcionBien.equalsIgnoreCase("Juegos de azar/casino")){
                    codigoBien = 4 + "";
                }else if(descripcionBien.equalsIgnoreCase("Cancha Sintetica")){
                    codigoBien = 5 + "";
                }
            }
            ...
            if(subcategoria.equalsIgnoreCase("Vehículos y Serviteca")){
                ...
                if(descripcionBien.equalsIgnoreCase("Vehículos/Motos")) {
                    codigoBien = 1 + "";
                }else if(descripcionBien.equalsIgnoreCase("Servicios de Serviteca")){
                    codigoBien = 2 + "";
                }
            }
                        ...
                        case "3":
                            ...
                            switch(codigoBien){
                                ...
                                case "3":
                                    ...
                                    break;
                                case "4":
                                    tipoBien = "Video, Sonido y Tecnología";
                                    break;
                                case "5":
                        ...
                        case "2":
                            ...
                            switch(codigoBien){
                                ...
                                case "2":
                                    ...
                                    break;
                                case "3":
                                    tipoBien = "Panadería y Pastelería";
                                    break;
                                case "4":
                                    tipoBien = "Café, Postres y Helados";
                                    break;
                                case "5":
                                    tipoBien = "Bares";
                                    break;
                        ...
                        case "4":
                            ...
                            switch(codigoBien){
                                case "1":
                                    ...
                                    break;
                                case "2":
                                    tipoBien = "Servicios y equipos de telefonía";
                                    break;
                                case "3":
                                    tipoBien = "Servicio de Lavandería";
                                    break;
                                case "4":
                                    tipoBien = "Reparación de Vestuario";
                                    break;
                                case "5":
                                    tipoBien = "Reparación de Calzado";
                                    break;
                                case "6":
